...
describe('ASTDependencyAnalyzer - ESM and TSX Support', async () => {
  test('should resolve .js extension to .ts/.tsx files', async (t) => {
    ...
    try {
      const result = await analyzer.findIdentifierDefinition('Button', paths.mainPath);
  ...
  test('should analyze TSX component dependencies', async (t) => {
    ...
    try {
      const result = await analyzer.analyzeIdentifierDependencies('Button', paths.componentPath);
  ...
  test('should handle React types and hooks', async (t) => {
    ...
    try {
      const result = await analyzer.analyzeIdentifierDependencies('useCounter', paths.hookPath);
      ...
      assert.ok(
        result.sourceCode.includes('useState') && result.sourceCode.includes('useCallback'),
  ...
  test('should handle type imports with .js extension', async (t) => {
    ...
    try {
      const result = await analyzer.findIdentifierDefinition('ButtonProps', paths.componentPath);
  ...
  test('should handle namespace imports with .js extension', async (t) => {
    ...
    try {
      const result = await analyzer.findIdentifierDefinition('styleUtils', paths.mainPath);
